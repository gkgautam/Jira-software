...
function Navbarleft() {
    return (
        <>
            <div className='navbarLeft col-3 d-flex flex-column justify-content-between py-3 px-0' style={{ "backgroundColor": "#003e99", "color": "white","justifyContent":"center","gap":"285px","width":"64px" }}>
