  ...
  return (
    ...
    <div className='sidebar-secondary col-9 p-0 px-3 m-0' style={{ "backgroundColor": "rgb(244 245 247)" }}>
      ...
      <div className='dropdown-icon'>
        <svg width="20" height="24" viewBox="0 0 24 24" role="presentation"><path d="M8.292 10.293a1.009 1.009 0 000 1.419l2.939 2.965c.218.215.5.322.779.322s.556-.107.769-.322l2.93-2.955a1.01 1.01 0 000-1.419.987.987 0 00-1.406 0l-2.298 2.317-2.307-2.327a.99.99 0 00-1.406 0z" fill="currentColor" fill-rule="evenodd"></path></svg>
        </div>
    ...
    {/* items start here */}
        ...
        <div className='webapp-item d-flex align-items-center py-2' style={{ "paddingLeft": "20px", "gap": "16px" }}>
          {/* <FaGgCircle /> */}
      ...
      <div className='development-item d-flex align-items-center py-2' style={{ "paddingLeft": "20px", "gap": "16px" }}>
          {/* <FaGgCircle /> */}
          <svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><path d="M14.155 4.055a1 1 0 00-1.271.62l-4.83 14.046a1 1 0 001.891.65l4.83-14.045a1 1 0 00-.62-1.271m-6.138 8.21l-2.58-2.501L8.236 7.05a.999.999 0 10-1.392-1.436l-3.54 3.432a1 1 0 000 1.436l3.32 3.219a1 1 0 101.393-1.436m12.219 1.568l-3.32-3.22a.999.999 0 10-1.393 1.437l2.58 2.5-2.799 2.715a.999.999 0 101.392 1.436l3.54-3.432a1 1 0 000-1.436" fill="currentColor" fill-rule="evenodd"></path></svg>
          <div className='m-0' style={{ "fontSize": "14px", "fontWeight": "400", "color": "rgb(66,82,110)" }}> Code</div>
        </div>
        <div className='development-item d-flex align-items-center py-2' style={{ "paddingLeft": "20px", "gap": "16px" }}>
          {/* <FaGgCircle /> */}
          <svg width="24" height="24" viewBox="0 0 24 24" role="presentation"><g fill="currentColor" fill-rule="evenodd"><path d="M6 12h8v-2H6v2zM4 8.99C4 8.445 4.456 8 5.002 8h9.996C15.55 8 16 8.451 16 8.99V14H4V8.99z" fill-rule="nonzero"></path><path d="M6 7.005C6 5.898 6.898 5 7.998 5h2.004C11.106 5 12 5.894 12 7.005V10H6V7.005zm4 0V7H7.999c.005 0 .002.003.002.005V8h2v-.995z"></path><path d="M4.5 17h13.994l1.002-3H4.14l.36 3zm-2.495-4.012A.862.862 0 012.883 12h18.393c.55 0 .857.417.681.944l-1.707 5.112c-.174.521-.758.944-1.315.944H3.725a1.149 1.149 0 01-1.118-.988l-.602-5.024z" fill-rule="nonzero"></path></g></svg>
