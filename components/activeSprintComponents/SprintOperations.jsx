            ...
            <div className='operations-container my-3 row p-0'>
                ...
                <div className='operation-controls row col-8'>
                    ...
                    <div className='operation-buttons col-5 p-0 d-flex' style={{"gap":"8px"}}>
                        <div className='custom-pirmary-btn' style={{"fontSize":"14px","fontWeight":"500","backgroundColor": "rgba(9,30,66,0.04)", "padding": "1px 6px", "borderRadius": "2px","lineHeight":"24px","color":"#42526E"}}>
                            Only My Issues
                        </div>
                        <div className='custom-pirmary-btn' style={{"fontSize":"14px","fontWeight":"500","backgroundColor": "rgba(9,30,66,0.04)", "padding": "1px 6px", "borderRadius": "2px","lineHeight":"24px","color":"#42526E"}}>
                            Recently Updated
                ...
                <div className='operation-control-buttons col-2 p-0' style={{"marginLeft":"auto","width":"10%","marginRight":"12px"}}>
                <div className='custom-pirmary-btn' style={{"fontSize":"14px","fontWeight":"500","backgroundColor": "rgba(9,30,66,0.04)", "padding": "1px 6px", "borderRadius": "2px","lineHeight":"24px","color":"#42526E"}}>
