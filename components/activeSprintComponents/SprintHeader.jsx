    ...
    <>
      <div className='sprint-Header d-flex justify-content-between'>
        ...
        <div className='header-action d-flex justify-content-center align-items-center' style={{ "gap": "10px" }}>
          ...
          <div className='share'>
            <svg width="20" height="20" viewBox="0 0 24 24" role="presentation"><g fill="currentColor" fill-rule="evenodd"><path d="M6 15a3 3 0 100-6 3 3 0 000 6zm0-2a1 1 0 110-2 1 1 0 010 2zm12-4a3 3 0 100-6 3 3 0 000 6zm0-2a1 1 0 110-2 1 1 0 010 2zm0 14a3 3 0 100-6 3 3 0 000 6zm0-2a1 1 0 110-2 1 1 0 010 2z" fill-rule="nonzero"></path><path d="M7 13.562l8.66 5 1-1.732-8.66-5z"></path><path d="M7 10.83l1 1.732 8.66-5-1-1.732z"></path></g></svg>
          </div>
          <div>...</div>
        </div>
      </div>
